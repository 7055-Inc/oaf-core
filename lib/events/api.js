...
export async function createEvent(eventData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events`, {
    method: 'POST',
...
export async function updateEvent(eventId, eventData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/${eventId}`, {
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(eventData)
  });
...
export async function createCustomEvent(eventData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/custom`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(eventData)
  });
...
export async function updateCustomEvent(eventId, eventData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/custom/${eventId}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(eventData)
  });
...
export async function createJuryPacket(payload) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/jury-packets`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function updateJuryPacket(id, payload) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/jury-packets/${id}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload)
  });
...
export async function uploadJuryPacketFiles(files) {
  ...
  const response = await secureApiRequest(`${API_BASE}/api/jury-packets/upload`, {
    method: 'POST',
    body: formData
  });
  const data = await response.json();
...
export async function addApplicationField(eventId, fieldData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/${eventId}/application-fields`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function addAvailableAddon(eventId, addonData) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/${eventId}/available-addons`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function claimNew(token) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/claim/new/${token}`, {
    method: 'POST'
  });
  const data = await response.json();
  if (!response.ok || !data.success) {
...
export async function linkExistingClaim(token, eventId) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/claim/link/${token}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function resendClaimEmail(eventId) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/admin/unclaimed/${eventId}/resend`, {
    method: 'POST'
  });
  const data = await response.json();
  if (!data.success) {
...
export async function deleteUnclaimedEvent(eventId) {
  const response = await secureApiRequest(`${API_BASE}/api/v2/events/admin/unclaimed/${eventId}`, {
    method: 'DELETE'
  });
  const data = await response.json();
  if (!data.success) {
