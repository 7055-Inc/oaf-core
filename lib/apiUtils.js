...
export const authApiRequest = async (endpoint, options = {}) => {
  const url = getApiUrl(endpoint);
  return authenticatedApiRequest(url, options);
};
...
export const API_ENDPOINTS = {
  ...
  // Users — migrated to helper functions in lib/users/api.js
  ...
  // Dashboard — widgets migrated to /api/v2/system/dashboard-widgets/* (inline paths)
  DASHBOARD: 'dashboard',
