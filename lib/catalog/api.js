...
export async function fetchVariationTypes() {
  const response = await authenticatedApiRequest(
    getApiUrl(`${CATALOG_BASE}/products/variations/types`),
    { method: 'GET' }
  );
  if (!response.ok) {
    const err = await response.json();
    throw new Error(err.error?.message || 'Failed to fetch variation types');
  }
  const data = await response.json();
  return data.data;
}
...
export async function createVariationType(variationName) {
  ...
  if (!response.ok) {
    const err = await response.json();
    throw new Error(err.error?.message || 'Failed to create variation type');
  }
  const data = await response.json();
  return data.data;
}
...
export async function fetchVariationValues(typeId, productId) {
  const url = productId
    ? `${CATALOG_BASE}/products/variations/types/${typeId}/values?product_id=${productId}`
    : `${CATALOG_BASE}/products/variations/types/${typeId}/values`;
...
export async function createVariationValue(typeId, valueName, productId) {
  const response = await authenticatedApiRequest(
    getApiUrl(`${CATALOG_BASE}/products/variations/values`),
    {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
  ...
  if (!response.ok) {
    const err = await response.json();
    throw new Error(err.error?.message || 'Failed to add variation value');
  }
  const data = await response.json();
  return data.data;
}
...
export async function deleteVariationType(typeId) {
  const response = await authenticatedApiRequest(
    getApiUrl(`${CATALOG_BASE}/products/variations/types/${typeId}`),
    { method: 'DELETE', headers: { 'Content-Type': 'application/json' } }
  );
  if (!response.ok) {
    const err = await response.json();
    throw new Error(err.error?.message || 'Failed to delete variation type');
  }
}

export async function createProductVariationRecord(productId, variationTypeId, variationValueId) {
  const response = await authenticatedApiRequest(
    getApiUrl(`${CATALOG_BASE}/products/variations`),
    {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
  ...
  if (!response.ok) {
    const err = await response.json();
    throw new Error(err.error?.message || 'Failed to create variation record');
  }
  const data = await response.json();
  return data.data;
}
...
export async function uploadProductImagesBulk(productId, files) {
  ...
  const response = await authenticatedApiRequest(
    getApiUrl(`${CATALOG_BASE}/products/upload?product_id=${productId}`),
...
export async function fetchWalmartCategories() {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to fetch Walmart categories');
...
export async function fetchWalmartProducts() {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to fetch Walmart products');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function fetchWalmartProduct(productId) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to fetch product');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function saveWalmartProduct(productId, body) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to save product');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function removeWalmartProduct(productId) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to remove product');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function fetchWalmartAdminProducts(params = {}) {
  ...
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to fetch products');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function activateWalmartProduct(productId) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to activate');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function pauseWalmartProduct(productId) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to pause');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function updateWalmartAdminProduct(productId, body) {
  ...
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to update');
  const payload = data.data || data;
  return { success: true, ...payload };
}
...
export async function updateWayfairProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${WAYFAIR_BASE}/products/${productId}`), {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
...
export async function fetchWayfairAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${WAYFAIR_BASE}/allocations`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.error || 'Failed to fetch allocations');
  return data;
}

export async function testWayfairConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${WAYFAIR_BASE}/test`), { method: 'GET' });
  const data = await response.json();
  return data;
}
...
// =============================================================================
// AMAZON CONNECTOR (v2 catalog addon - OAuth only)
// =============================================================================

const AMAZON_BASE = `${CATALOG_BASE}/amazon`;

export async function amazonOAuthAuthorize() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/oauth/authorize`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchAmazonShops() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/shops`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Amazon shops');
  return data.data;
}

export async function disconnectAmazonShop(shopId) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/shops/${shopId}/disconnect`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to disconnect shop');
  return data;
}

export async function fetchAmazonProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Amazon products');
  return data.data;
}

export async function saveAmazonProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/products/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to save Amazon product');
  return data;
}

export async function fetchAmazonAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/inventory`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch allocations');
  return data.data;
}

export async function saveAmazonAllocation(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/inventory/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to update allocation');
  return data;
}

export async function fetchAmazonLogs(options = {}) {
  const params = new URLSearchParams();
  if (options.limit) params.set('limit', String(options.limit));
  if (options.sync_type) params.set('sync_type', options.sync_type);
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/logs?${params}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch logs');
  return data.data;
}

export async function testAmazonConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/test`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchAmazonAdminProducts(options = {}) {
  const params = new URLSearchParams();
  if (options.status) params.set('status', options.status);
  if (options.page) params.set('page', String(options.page));
  if (options.limit) params.set('limit', String(options.limit));
  if (options.search) params.set('search', options.search);
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/admin/products?${params}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch admin products');
  return data.data;
}

export async function activateAmazonProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/admin/products/${productId}/activate`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to activate');
  return data;
}

export async function pauseAmazonProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/admin/products/${productId}/pause`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to pause');
  return data;
}

export async function updateAmazonAdminProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/admin/products/${productId}`), {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
...
// Amazon Corporate Catalog
export async function fetchAmazonCorporateProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/corporate/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate products');
  return data;
}

export async function fetchAmazonCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/corporate/products/${productId}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate product');
  return data;
}

export async function saveAmazonCorporateProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/corporate/products/${productId}`), {
...
export async function removeAmazonCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${AMAZON_BASE}/corporate/products/${productId}`), { method: 'DELETE' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to remove corporate product');
  return data;
}
...
// =============================================================================
// FAIRE CONNECTOR (v2 catalog addon - OAuth only, wholesale)
// =============================================================================

const FAIRE_BASE = `${CATALOG_BASE}/faire`;

export async function faireOAuthAuthorize() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/oauth/authorize`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchFaireShops() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/shops`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Faire shops');
  return data.data;
}

export async function disconnectFaireShop(shopId) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/shops/${shopId}/disconnect`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to disconnect brand');
  return data;
}

export async function fetchFaireProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Faire products');
  return data.data;
}

export async function saveFaireProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/products/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to save Faire product');
  return data;
}

export async function fetchFaireAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/inventory`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch allocations');
  return data.data;
}

export async function saveFaireAllocation(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/inventory/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
...
export async function fetchFaireLogs(options = {}) {
  const params = new URLSearchParams();
  if (options.limit) params.set('limit', String(options.limit));
  if (options.sync_type) params.set('sync_type', options.sync_type);
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/logs?${params}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch logs');
  return data.data;
}

export async function testFaireConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/test`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchFaireAdminProducts(options = {}) {
  const params = new URLSearchParams();
  if (options.status) params.set('status', options.status);
  if (options.page) params.set('page', String(options.page));
  if (options.limit) params.set('limit', String(options.limit));
  if (options.search) params.set('search', options.search);
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/admin/products?${params}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch admin products');
  return data.data;
}

export async function activateFaireProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/admin/products/${productId}/activate`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to activate');
  return data;
}

export async function pauseFaireProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/admin/products/${productId}/pause`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to pause');
  return data;
}

export async function updateFaireAdminProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/admin/products/${productId}`), {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
...
// Faire Corporate Catalog
export async function fetchFaireCorporateProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/corporate/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate products');
  return data;
}

export async function fetchFaireCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/corporate/products/${productId}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate product');
  return data;
}

export async function saveFaireCorporateProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/corporate/products/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to save corporate product');
...
export async function removeFaireCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${FAIRE_BASE}/corporate/products/${productId}`), { method: 'DELETE' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to remove corporate product');
  return data;
}
...
// =============================================================================
// META CONNECTOR (v2 catalog addon - hybrid: OAuth + Corporate)
// =============================================================================

const META_BASE = `${CATALOG_BASE}/meta`;

export async function metaOAuthAuthorize() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/oauth/authorize`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchMetaShops() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/shops`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Meta shops');
  return data.data;
}

export async function disconnectMetaShop(shopId) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/shops/${shopId}/disconnect`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to disconnect');
  return data;
}

export async function fetchMetaProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch products');
  return data.data;
}

export async function saveMetaProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/products/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
...
export async function fetchMetaAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/inventory`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch allocations');
  return data.data;
}

export async function saveMetaAllocation(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/inventory/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to update');
...
export async function fetchMetaLogs(options = {}) {
  const params = new URLSearchParams();
  if (options.limit) params.set('limit', String(options.limit));
  if (options.sync_type) params.set('sync_type', options.sync_type);
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/logs?${params}`), { method: 'GET' });
  const data = await response.json();
...
export async function testMetaConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/test`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchMetaAdminProducts(options = {}) {
  const params = new URLSearchParams();
  if (options.status) params.set('status', options.status);
  if (options.page) params.set('page', String(options.page));
  if (options.limit) params.set('limit', String(options.limit));
  if (options.search) params.set('search', options.search);
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/admin/products?${params}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
  return data.data;
}

export async function activateMetaProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/admin/products/${productId}/activate`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
  return data;
}

export async function pauseMetaProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/admin/products/${productId}/pause`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
  return data;
}

export async function updateMetaAdminProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/admin/products/${productId}`), {
...
export async function fetchMetaCorporateProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/corporate/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate products');
  return data;
}

export async function fetchMetaCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/corporate/products/${productId}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed');
  return data;
}

export async function saveMetaCorporateProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/corporate/products/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed');
...
export async function removeMetaCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${META_BASE}/corporate/products/${productId}`), { method: 'DELETE' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed');
  return data;
}
...
const SHOPIFY_BASE = `${CATALOG_BASE}/shopify`;

export async function fetchShopifyShops() {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/shops`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Shopify shops');
  return data.data || data;
}

export async function disconnectShopifyShop(shopId) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/shops/${encodeURIComponent(shopId)}/disconnect`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to disconnect shop');
  return data.data || data;
}

export async function shopifyOAuthAuthorize(shopDomain, from) {
  let url = `${SHOPIFY_BASE}/oauth/authorize?shop=${encodeURIComponent(shopDomain)}`;
  if (from) url += `&from=${encodeURIComponent(from)}`;
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.message || 'OAuth failed');
  return data;
}

export async function fetchShopifyProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch Shopify products');
  return data.data || data;
}

export async function saveShopifyProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/products/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to save product');
  return data.data || data;
}

export async function fetchShopifyAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/inventory`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch allocations');
  return data.data || data;
}

export async function saveShopifyAllocation(productId, allocated_quantity) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/inventory/${productId}`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ allocated_quantity }),
  });
...
export async function bulkShopifyAllocations(allocations) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/allocations/bulk`), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ allocations }),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Bulk update failed');
  return data.data || data;
}

export async function fetchShopifyLogs(params = {}) {
  const qs = new URLSearchParams(params).toString();
  const url = qs ? `${SHOPIFY_BASE}/logs?${qs}` : `${SHOPIFY_BASE}/logs`;
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch logs');
  return data.data || data;
...
export async function testShopifyConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/test`), { method: 'GET' });
  const data = await response.json();
  return data;
}

export async function fetchShopifyAdminProducts(params = {}) {
  const qs = new URLSearchParams(params).toString();
  const url = qs ? `${SHOPIFY_BASE}/admin/products?${qs}` : `${SHOPIFY_BASE}/admin/products`;
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch products');
  return data.data || data;
...
export async function activateShopifyProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/admin/products/${productId}/activate`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to activate');
  return data.data || data;
}

export async function pauseShopifyProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/admin/products/${productId}/pause`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to pause');
  return data.data || data;
}

export async function updateShopifyAdminProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${SHOPIFY_BASE}/admin/products/${productId}`), {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body),
  });
...
const EBAY_BASE = `${CATALOG_BASE}/ebay`;

export async function fetchEbayShops() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/shops`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch eBay accounts');
  return data.data || data;
}

export async function disconnectEbayShop(shopId) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/shops/${encodeURIComponent(shopId)}/disconnect`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to disconnect');
  return data.data || data;
}

export async function ebayOAuthAuthorize() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/oauth/authorize`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || data.message || 'OAuth failed');
  return data;
}
...
export async function fetchEbayProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch products');
  return data.data || data;
}

export async function saveEbayProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/products/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to save');
...
export async function fetchEbayAllocations() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/inventory`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch allocations');
  return data.data || data;
}

export async function saveEbayAllocation(productId, allocated_quantity) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/inventory/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ allocated_quantity }),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to update');
  return data.data || data;
...
export async function fetchEbayLogs(params = {}) {
  const qs = new URLSearchParams(params).toString();
  const url = qs ? `${EBAY_BASE}/logs?${qs}` : `${EBAY_BASE}/logs`;
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed to fetch logs');
  return data.data || data;
...
export async function testEbayConnection() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/test`), { method: 'GET' });
  return await response.json();
}

export async function fetchEbayAdminProducts(params = {}) {
  const qs = new URLSearchParams(params).toString();
  const url = qs ? `${EBAY_BASE}/admin/products?${qs}` : `${EBAY_BASE}/admin/products`;
  const response = await authenticatedApiRequest(getApiUrl(url), { method: 'GET' });
  const data = await response.json();
...
export async function activateEbayProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/admin/products/${productId}/activate`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
  return data.data || data;
}

export async function pauseEbayProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/admin/products/${productId}/pause`), { method: 'POST' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
  return data.data || data;
}

export async function updateEbayAdminProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/admin/products/${productId}`), {
    method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error?.message || 'Failed');
...
// eBay Corporate Catalog
export async function fetchEbayCorporateProducts() {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/corporate/products`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate products');
  return data;
}

export async function fetchEbayCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/corporate/products/${productId}`), { method: 'GET' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to fetch corporate product');
  return data;
}

export async function saveEbayCorporateProduct(productId, body) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/corporate/products/${productId}`), {
    method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body),
  });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to save corporate product');
...
export async function removeEbayCorporateProduct(productId) {
  const response = await authenticatedApiRequest(getApiUrl(`${EBAY_BASE}/corporate/products/${productId}`), { method: 'DELETE' });
  const data = await response.json();
  if (!data.success) throw new Error(data.error || 'Failed to remove corporate product');
  return data;
}
