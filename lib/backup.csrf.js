...
export async function refreshAuthToken() {
  ...
  try {
    ...
    document.cookie = `token=${data.token}; path=/; domain=.beemeeart.com; secure; samesite=lax`;
    document.cookie = `refreshToken=${data.refreshToken}; path=/; domain=.beemeeart.com; secure; samesite=lax`;
...
export function clearAuthTokens() {
  ...
  // Clear cookies
  document.cookie = 'token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.beemeeart.com';
  document.cookie = 'refreshToken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.beemeeart.com';
  document.cookie = 'csrf-token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.beemeeart.com';
  document.cookie = 'csrf-secret=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.beemeeart.com';
...
export function getAuthToken() {
  ...
  if (localToken) {
    ...
    document.cookie = `token=${localToken}; path=/; domain=.beemeeart.com; secure; samesite=lax`;
    return localToken;
  }
