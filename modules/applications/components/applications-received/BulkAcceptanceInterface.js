  ...
  return (
    <div className="form-card" style={{ marginBottom: '20px' }}>
      ...
      <div style={{ marginBottom: '20px', border: '1px solid #e5e7eb', borderRadius: '8px', overflow: 'hidden' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '40px 1fr 100px 90px 90px 80px', gap: '12px', padding: '12px 16px', backgroundColor: '#f9fafb', fontWeight: '600', fontSize: '14px' }}>
          <div>
            <input
              type="checkbox"
        ...
        {applications.map((application) => (
          <div key={application.id} style={{ display: 'grid', gridTemplateColumns: '40px 1fr 100px 90px 90px 80px', gap: '12px', padding: '12px 16px', alignItems: 'center', borderTop: '1px solid #e5e7eb' }}>
            <div>
              <input
                type="checkbox"
            ...
            <div>{new Date(application.applied_date).toLocaleDateString()}</div>
            <div>{formatCurrency(bulkBoothFee || application.booth_fee)}</div>
            <div>
              {formatCurrency(
            ...
            <div>
              <span className="status-badge muted" style={{ fontSize: '12px' }}>
