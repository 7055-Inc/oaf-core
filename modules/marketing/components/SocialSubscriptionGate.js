/**
 * SocialSubscriptionGate
 *
 * Gate for Social Central pages: if user has not completed subscription
 * (tier, terms, card), show the ChecklistController flow in place.
 * If complete, show the wrapped page content.
 *
 * Same pattern as WebsitesSubscriptionGate.js
 */

import React, { useState, useEffect } from 'react';
import { authApiRequest } from '../../../lib/apiUtils';
import ChecklistController from '../../../components/subscriptions/ChecklistController';
import { getSocialSubscriptionConfig } from './socialSubscriptionConfig';

const SUBSCRIPTION_TYPE = 'social';
const SOCIAL_CONFIG = getSocialSubscriptionConfig(() => null);
const SUBSCRIPTION_MY_URL = SOCIAL_CONFIG.subscriptionApiBase
  ? `${SOCIAL_CONFIG.subscriptionApiBase}/subscription/my`
...
export default function SocialSubscriptionGate({ userData, children }) {
  ...
  const config = getSocialSubscriptionConfig((props) =>
