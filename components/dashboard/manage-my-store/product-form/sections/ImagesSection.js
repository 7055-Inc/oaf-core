...
export default function ImagesSection() {
  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      ...
      // Use the correct endpoint with product_id as query param
      const productIdParam = savedProductId || 'new';
      const res = await authApiRequest(`products/upload?product_id=${productIdParam}`, {
        method: 'POST',
        body: uploadFormData
      });
