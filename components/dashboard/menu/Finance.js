      ...
      {!collapsedSections.finance && (
        <ul>
          ...
          <li>
            <button 
              className={styles.sidebarLink}
              onClick={() => openSlideIn('payouts-earnings')}
            >
              Payouts & Earnings
            </button>
          </li>
...
// Payouts & Earnings Slide-in Content
function PayoutsEarningsContent({ userData, onBack }) {
    ...
    return (
      <div className={slideInStyles.container}>
        <div className={slideInStyles.header}>
          ...
          <h1 className={slideInStyles.title}>Payouts & Earnings</h1>
        </div>
        <div className={slideInStyles.content}>
        ...
        <div className="section-box">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
            <div className="form-card">
              ...
              <small className={slideInStyles.helpText}>Ready to withdraw from Stripe</small>
            </div>
            <div className="form-card">
              ...
              <small className={slideInStyles.helpText}>Held by platform during countdown</small>
            </div>
            <div className="form-card">
                    ...
                    <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '14px' }}>
                          <span className={`${slideInStyles.statusBadge} ${slideInStyles[payout.status] || ''}`}>
                            {payout.status}
                          </span>
                        </div>
                      </div>
...
export function FinanceSlideIn({ 
  ...
  switch (slideInContent.type) {
    ...
    case 'payouts-earnings':
      return <PayoutsEarningsContent userData={userData} onBack={closeSlideIn} />;
...
export const financeSlideInTypes = ['transaction-history', 'payouts-earnings'];
