...
export default function MakersHeader({ 
  logo = "/static_media/brakebee-logo.png", 
  logoLink = "/",
  navigation = [
    { label: "Why Brakebee", href: "#why-brakebee" },
    { label: "Features", href: "/makers/features" },
    { label: "How it Works", href: "#how-it-works" },
    { label: "Pricing", href: "#pricing" },
    { label: "Success Stories", href: "#success-stories" }
  ], 
  primaryButton = { text: "Start Selling", href: "/signup" },
  secondaryButton = { text: "Learn More", href: "/makers/features" },
  sticky = true 
}) {
  ...
  const handleNavClick = (item) => {
    if (item.href) {
      if (item.href.startsWith('http')) {
        ...
        // Check if we're on the main /makers page
        if (router.pathname === '/makers') {
          const element = document.querySelector(item.href);
          if (element) {
            element.scrollIntoView({ behavior: 'smooth' });
          }
        } else {
          // Navigate to /makers with the anchor
          router.push(`/makers${item.href}`);
        }
